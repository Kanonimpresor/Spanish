...
define("ADMSLAN_25", "Subir/gestionar archivos");
...
define("ADMSLAN_41", "Crear/editar menús personalizados");  
define("ADMSLAN_42", "Publicar reseñas");
...
define("ADMSLAN_58", "Administrador principal del sitio");
define("ADMSLAN_59", "Eliminar estatus de administrador");
...
define("ADMSLAN_71", "Haz clic aquí para mostrar privilegios");

define("ADMSLAN_72", "ID de admin: [x] nombre: [y] nuevos permisos: ");
define("ADMSLAN_73", "ID de admin: [x] nombre: [y]");

//define("ADMSLAN_2", "Site Administrator [name] updated in database.");
